...
def Api_connect():
    Api_Id="AIzaSyCZNDgHBgucH8ZsbagGUElieSLwERCHJ3Q"
...
client=pymongo.MongoClient("mongodb+srv://venkatmuthu187:venkatesan@cluster0.zb3xqog.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
def videos_table(channel_name_s):
    ...
    single_vidoes_details= []
    db=client["Youtube_data"]
    coll1=db["channel_details"]
    for ch_data in coll1.find({"channel_information.Channel_Name":channel_name_s},{"_id":0}):
        single_vidoes_details.append(ch_data["video_information"])

    df_single_vidoes_detail= pd.DataFrame(single_vidoes_details[0])
   

    for index,row in df_single_vidoes_detail.iterrows():
...
with st.sidebar:
    ...
    st.header(":yellow[Skill Take Away]")
...
if question=="1. All the videos and the channel name":
    ...
    fig_1= px.pie(df2, values= "No of videos", names= "channel name", title="channels with most number of videos",
    ...
    fig_2= px.pie(df3, names= "videotitle", values= "views",title= "10 most viewed videos",
    ...
    fig_3= px.bar(df7, x= "channel name", y= "totalviews",title= "views of each channel",
                    color_discrete_sequence= px.colors.sequential.Oranges_r)
